...
public class PartidaSmokeTest {
    public static void main(String[] args) throws Exception {
        ...
        if (aliados != 1) System.out.println("ERROR: El jugador tiene más de un proyectil activo.");
        else System.out.println("OK: El jugador tiene solo un proyectil activo.");
        ...
        if (enemAct > maxExpected) System.out.println("ERROR: Superó el máximo de proyectiles enemigos");
        else System.out.println("OK: No se supera el máximo de proyectiles enemigos.");
        ...
        int vivas = 0;
        for (NaveInvasora n : naves) if (n.isViva()) vivas++;
